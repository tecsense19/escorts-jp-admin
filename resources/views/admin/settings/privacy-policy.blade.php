@php
    ...
    $description = isset($datas) ? $datas->descirption : '';
@endphp
                ...
                <div class="card">
                    <div class="card-body pt-3">
                        <div class="tab-content pt-2">
                            <!-- Profile Edit Form -->
                            <form class="row g-3" method="POST" action="{{ route('admin.save.privacypolicy') }}" id="profileForm" enctype='multipart/form-data'>
                                {!! csrf_field() !!}
                                <div class="row mb-3">
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-md-8 col-lg-9">
                                        <textarea name="descirption" class="form-control editor" id="about" style="height: 100px">{{$description}}</textarea>
                                    </div>
                                </div>
